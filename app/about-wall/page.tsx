...
export default function AboutWallPage() {
  ...
  return (
    <main className="flex min-h-full w-full flex-col items-center bg-primary-bg px-4 py-10 text-primary-text">
      <section className="flex w-full max-w-5xl flex-col gap-6 rounded-3xl border border-primary-border bg-primary-card p-6 shadow-lg">
